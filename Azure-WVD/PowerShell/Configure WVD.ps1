...
#    General Variables    #
###########################                 
$AADTenantID = 'a2760153-5887-4d08-9fa2-78013c75bd2c'
$SubscriptionID = '80a0e3c0-1a77-4a57-a797-d9d5e4320e3f'
$WVDTenantName = 'MKVDesk-Tenant'
$WVDTenantGroup = 'MKVDesk Tenant Group'
$WVDHostPoolName = 'mkdpool'
$FirstAppGroupName = 'mkv-WVD'
$AzureADGlobalAdmin = 'WVD'
$AzureADDomainName = 'mkvdesk.com'
